        ...
        >
          ...
          <View className="flex-1 bg-white px-6 pb-2 pt-8">
            ...
            <View className="mb-6">
              ...
              <Text className="text-sm text-gray-500">Sign up to get started as a passenger.</Text>
            </View>
            ...
            */}
            ...
            <View className="items-center" style={{ paddingBottom: Math.max(insets.bottom, 32) }}>
              <Text className="text-sm text-gray-600">
                ...
                <Text className="font-semibold text-primary" onPress={() => navigation.navigate('PassengerLogin')}>
                  Login
                </Text>
              </Text>
            </View>
...
export default PassengerCreateAccountScreen;
