  ...
  try {
    ...
    const [rideRows, lostItems, panicAlerts] = await Promise.all([
      query(
        ...
        ride_requests.passenger_count,
        ride_requests.driver_user_id,
        ride_requests.driver_name,
        ride_requests.requested_tier_key,
        ride_requests.requested_tier_name,
        ride_requests.pickup_label,
        ride_requests.dropoff_label,
        ride_requests.intermediate_stops_json,
        ...
        ride_requests.dropoff_lng,
        ride_requests.route_polyline,
        ride_requests.route_distance_km,
        ride_requests.route_duration_minutes,
        ride_requests.estimated_distance_km,
        ride_requests.estimated_minutes,
        ride_requests.estimated_amount,
        ride_requests.original_estimated_amount,
        ride_requests.discount_amount,
        ride_requests.final_estimated_amount,
        ride_requests.driver_reimbursement_amount,
        ride_requests.discount_code,
        ride_requests.tip_amount,
        ride_requests.status,
        ride_requests.requested_at,
        ride_requests.assigned_at,
        ride_requests.arrived_at,
        ride_requests.started_at,
        ride_requests.completed_at,
        ride_requests.actual_distance_km,
        ride_requests.actual_minutes,
        ...
        ride_requests.passenger_driver_rating,
        ride_requests.passenger_driver_review,
        ride_requests.passenger_driver_feedback_tags,
        ride_requests.passenger_driver_rated_at,
